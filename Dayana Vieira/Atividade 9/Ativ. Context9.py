...
def salvando ():
     ...
     with open('Atividade9\\anguloprocessado9.csv', 'w', newline='') as csvfile:
     ...
     with open('Atividade9\\anguloprocessado9.csv','r',newline='') as csvfile:
          spamreader = csv.reader(csvfile,delimiter=' ',quotechar='|')
          for row in spamreader:
               print(','.join(row))
     with open('Atividade9\\anguloprocessado9.txt','w') as FileObject:
     ...
     with open('Atividade9\\anguloprocessado9.txt','r') as FileObject:
