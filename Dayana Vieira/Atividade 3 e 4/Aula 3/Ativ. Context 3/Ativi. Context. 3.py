...
print("“Houve alteração na variável inserida?",ResolucaoImagem != ResolucaoImagem2 and ResolucaoImagem2 != "32 x 32" and ResolucaoImagem2 != "64 X 64" and ResolucaoImagem2 != "64X64")
