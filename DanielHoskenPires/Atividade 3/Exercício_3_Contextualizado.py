...
print('Houve alteração na variável inserida? ', LigarMicroscopio != Comparativo)
...
print('Houve alteração na variável inserida? ', ResolucaoImagem != Comparativo)

Comparativo = TipoCelula
TipoCelula =  (input("Qual é o típo de célula a ser analisada? \n"))
print('Houve alteração na variável inserida? ', TipoCelula != Comparativo)
...
print('Houve alteração na variável inserida? ', FaixaIluminacao != Comparativo)
...
print('Houve alteração na variável inserida? ', Intensidade != Comparativo)
...
print('Houve alteração na variável inserida? ', ComprimentoOnda != Comparativo)

Comparativo = False
FeixeLaiser = bool (input("Deseja ligar o feixe de laser? (Aperte qualquer tecla para ligar ou enter para manter desligado) \n" ))
print('Houve alteração na variável inserida? ', FeixeLaiser != Comparativo)
...
print('Houve alteração na variável inserida? ', LigarFluorecencia != Comparativo)

Comparativo = False
LigarArgonio = bool (input("Deseja ligar o Argônio? (Aperte qualquer tecla para ligar ou enter para manter desligado) \n" ))
print('Houve alteração na variável inserida? ', LigarArgonio != Comparativo)
...
print('Houve alteração na variável inserida? ', AtualizacaoSistema != Comparativo)
